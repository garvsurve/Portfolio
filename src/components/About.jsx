import { BookOpen, Coffee, Rocket, Trophy, Zap, GraduationCap, Flame } from 'lucide-react';

const stats = [
  { value: '75', label: 'GFG Rank', icon: <Trophy className="text-neo-ink" />, color: 'bg-neo-secondary' },
  { value: '1500+', label: 'LeetCode', icon: <Zap className="text-neo-ink" />, color: 'bg-neo-accent' },
  { value: '7.55', label: 'Eng. GPA', icon: <GraduationCap className="text-neo-ink" />, color: 'bg-neo-muted' },
  { value: '100%', label: 'Passion', icon: <Flame className="text-neo-ink" />, color: 'bg-neo-white' },
];
            ...
            <div className="relative group">
              ...
              <div className="relative bg-neo-white border-4 border-black p-8 md:p-12 space-y-6 bg-halftone">
                <p className="text-xl md:text-2xl font-bold leading-relaxed">
                  ...
                  My toolkit revolves around Java, Spring Boot, and React.
                </p>
                ...
                <p className="text-xl md:text-2xl font-bold leading-relaxed border-t-4 border-black pt-6">
                  When I&apos;m not coding, you&apos;ll find me solving DSA problems (GFG Rank #75), exploring distributed systems, 
